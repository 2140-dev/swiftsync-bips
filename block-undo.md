...
# References
- Relevant statistics may be generated via binaries in the [`swiftsync-research`](https://github.com/rustaceanrob/swiftsync-research) repository
- Reconstructable scripts are borrowed from [UTREEXO](https://github.com/bitcoin/bips/pull/1923) which is subsequently borrowed from Cory Field's UHS proposal
